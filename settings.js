...
const BOTNAME = 'rush-md|-whatsapp';
const FOOTERNAME = '> rush-md-v1';
global.owner = process.env.OWNER_NUMBER  || '94760000000' ;  // ADD YOUR NUMBER 
...
FOOTER: process.env.FOOTER || '‌RUSH-MD-V1',    
